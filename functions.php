...
add_action('wp_enqueue_scripts', 'nelsongentry_scripts', 100);
function nelsongentry_scripts(){
  wp_register_script(
    'bootstrap-script', 
  ...
  /*
  wp_register_script(
    'nelsongentry-scripts', 
    get_template_directory_uri() . '/js/nelsongentry-scripts.js', 
    array('jquery'), 
    '', 
    true
  );
  */
  ...
  //wp_enqueue_script('nelsongentry-scripts');  
}

add_action('wp_enqueue_scripts', 'nelsongentry_styles');
function nelsongentry_styles(){
  wp_register_style('bootstrap-css', '//maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css');
  wp_register_style('nelsongentry', get_template_directory_uri() . '/style.css');
  
  wp_enqueue_style('bootstrap-css');
  wp_enqueue_style('nelsongentry');
}
...
function nelsongentry_fallback_header_menu(){ ?>
...
add_action('init', 'nelsongentry_create_post_type');
function nelsongentry_create_post_type(){
  $events_labels = array(
    'name' => 'Events',
    'singular_name' => 'Event',
    'menu_name' => 'Events',
  ...
  $events_args = array(
    ...
    'query_var' => 'campaign_events',
    'supports' => array('title', 'editor', 'custom_fields', 'revisions')
  );
  register_post_type('campaign_events', $events_args);
}